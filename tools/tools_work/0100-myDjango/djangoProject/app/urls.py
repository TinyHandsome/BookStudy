...
from app.views import func1_views, index_views, func2_views, func3_views, func4_views, func5_views, func6_views, \
    func7_get_columns_view, func8_idcard_code_country_view, func0_test, index_mark_views

urlpatterns = [
    path('', index_views.index, name='index'),
    path('index/', index_mark_views.index, name='index_mark'),
    ...
    path('generate_new_hive_schedule/', func6_views.func6_generate_new_hive_schedule,
         name='func6_generate_new_hive_schedule'),
    ...
    path('get_idcard_code_country/',
         func8_idcard_code_country_view.func8_idcard_code_country, name='func8'),
]
